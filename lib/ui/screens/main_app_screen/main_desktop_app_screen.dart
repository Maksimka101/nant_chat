...
class _MainDesktopAppScreenState extends State<MainDesktopAppScreen> {
  var _tabIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return SafeScaffold(
      body: Row(
        children: [
          NavigationRail(
            onDestinationSelected: _onTapSelected,
            destinations: [
              NavigationRailDestination(
                icon: const Icon(Icons.message_rounded, size: 30),
                label: Text(localization.rooms),
              ),
              NavigationRailDestination(
                ...
                label: Text(localization.profile),
              ),
            ],
